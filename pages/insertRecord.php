    ...
    <body>
        ...
        <?php
            ...
            if (isset($_POST['Submit'])) {  //submit button
                $sql = "INSERT INTO CLUB (ClubName, Description, Rating, Leader_StudentID) VALUES (:ClubName, :Description, :Rating, :Leader_StudentID);";
                try {
                    ...
                    $stmnt-> execute();
                    echo "<br/><p class='noticeText goodText'>Data Inserted</p>";
                } catch (PDOException $e) {
                    echo "<p class='noticeText badText' id='errorMessage'></p>";
                    echo '<script type="text/javascript">
                        document.getElementById("errorMessage").innerHTML = errorMessageCreator_insert("' .$e->getMessage(). '");
                        </script>';
                }
                unset($conn);
            }
